...
A hybrid RAG system for question answering on the SQuAD dataset. This implementation combines dense and sparse retrieval with reranking and LLM-based answer generation.
